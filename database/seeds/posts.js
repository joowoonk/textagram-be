...
exports.seed = function (knex) {
  ...
  const posts = [
    {
      ...
      user_id: 1,
      hashtagging: ["#friendship", "#friends", "#bestFriend"],
    },
    {
      ...
      user_id: 2,
      hashtagging: ["#bestMovie", "#forrest", "#gump", "#life"],
    },
    {
      ...
      user_id: 2,
      hashtagging: ["#movie", "#Rush", "#inspirational"],
    },
    {
      title: "One of best line I heard from Yoda!",
      context: "Do, or do not. There is no 'try' - Yoda",
      user_id: 3,
      hashtagging: ["#StarWars", "#MayTheForceBeWithYou", "#Yoda"],
    },
    {
  ...
  //   posts[i].hashtagging = string_to_array(posts[i].hashtagging);
